...
\begin{frame}
   ...
   the clustering:
  \begin{figure}
    \includegraphics[scale=0.1]{model_variance_standard_samples}
  \end{figure}
\end{frame}
%
%
\begin{frame}
  ...
  \begin{figure}
    \includegraphics[scale=0.1]{model_variance_more_samples}
  \end{figure}
\end{frame}
%
%
\begin{frame}
  ...
  \begin{figure}
    \includegraphics[scale=0.1]{model_variance_less_samples}
  \end{figure}
\end{frame}
%
%
\begin{frame}
  ...
  \begin{figure}
    \includegraphics[scale=0.1]{model_variance_more_error}
  \end{figure}
\end{frame}
